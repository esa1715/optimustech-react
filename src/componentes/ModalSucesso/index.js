...
const ModalSucesso = ({ msOpen, msClose }) => {
    useEffect(() => {
        if (msOpen) {
    ...
    <div className='background__modalsucesso' onClick={msClose}>
        <div className='modalsucesso' onClick={(e) => e.stopPropagation()}>
            ...
            <div className='modalsucesso__content'>
                <p>Bem-vindo!<br></br>Seu login foi realizado com sucesso!<br></br> Para sugestões ou contato, clique em uma das redes sociais abaixo.</p>
